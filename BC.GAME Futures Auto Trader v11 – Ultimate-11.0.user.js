// ==UserScript==
// @name         BC.GAME Futures Auto Trader v11 – Ultimate
// @namespace    http://tampermonkey.net/
// @version      11.0
// @description  All-in-one: Trailing, Martingale, MTF, Partial TP, Account Risk, v.v.
// @author       Souninjinma
...
(function() {
    ...
    ">
        <div id="bc-v11-header" style="
            ...
            cursor: move;
        ">
            <span style="font-weight: bold; color: #38bdf8;">🤖 Trader v11 (Ultimate)</span>
        ...
        <div id="bc-v11-body" style="padding: 12px 15px;">
            ...
            <div id="bc-v11-tab-trade" class="bc-v11-tab-content active">
                ...
                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
                    ...
                    <select id="bc-v11-strategy" style="margin-left: auto; background:#0f172a; border:1px solid #334155; color:#e2e8f0; padding:4px; border-radius:4px; font-size:11px;">
...
<div id="bc-v11-tab-guide" class="bc-v11-tab-content">
    <div style="max-height: 400px; overflow-y: auto; padding-right:5px;">
        ...
        <p style="text-align:center; font-size:10px; color:#64748b; margin-top:10px;">
            ...
            <div id="bc-v11-tab-help" class="bc-v11-tab-content">
                <p style="font-size:12px; color:#94a3b8;">Hỗ trợ discord : @souninjinma</p>
            </div>
        </div>
    </div>`;
    ...
    async function executePartialClose(closePercent) {
        ...
        // Tìm nút "1/2" hoặc trường nhập số lượng
    ...
    // ========== EXECUTE TRADE (cập nhật MTF, Account Risk, Partial TP) ==========
async function executeTrade(side) {
    ...
    if (soundCheck.checked) {
        try {
            new Audio('data:audio/wav;base64,').play();
        } catch(e) {}
    }
...
function checkPriceAlert() {
    ...
    if (currentPrice && alertValue && Math.abs(currentPrice - alertValue) / alertValue < 0.001) {
        ...
        if (soundCheck.checked) {
            try { new Audio('data:audio/wav;base64,').play(); } catch(e) {}
        }
    }
}
